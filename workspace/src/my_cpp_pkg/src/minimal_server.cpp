...
public:
    ...
    MinimalServer() : Node{"minimal_server"}
    {
        server_ = this->create_service<example_interfaces::srv::AddTwoInts>(
            "add_ints",
            std::bind(&MinimalServer::server_callback, this, std::placeholders::_1, std::placeholders::_2)
        );
    }
...
private:
        ...
        const example_interfaces::srv::AddTwoInts::Response::SharedPtr resp)
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Received request: a=%d and b=%d", (int)req->a, (int)req->b);
    }
};
